...
pub struct MyVectorResponse {
    events_byte_size: GroupedCountByteSize,
}

impl DriverResponse for MyVectorResponse {
...
pub struct MyVectorRequest {
    pub finalizers: EventFinalizers,
    pub metadata: RequestMetadata,
    pub request: proto_vector::PushEventsRequest,
}

impl Finalizable for MyVectorRequest {
    fn take_finalizers(&mut self) -> EventFinalizers {
        self.finalizers.take_finalizers()
    }
}

impl MetaDescriptive for MyVectorRequest {
...
impl Service<MyVectorRequest> for MyVectorService {
    ...
    fn call(&mut self, mut list: MyVectorRequest) -> Self::Future {
        ...
        let future = async move {
            service
                ...
                .map_ok(|_response| {
                    ...
                    MyVectorResponse { events_byte_size }
                })
                .map_err(|source| MyVectorSinkError::Request { source }.into())
                .await
        };
